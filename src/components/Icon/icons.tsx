export const EvDollar = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000">
    <path fill="currentColor" d="M11.25 8.08v2.86l-1-.35c-.52-.18-.83-.35-.83-1.22 0-.71.53-1.3 1.18-1.3h.65ZM14.58 14.63c0 .7-.53 1.29-1.18 1.29h-.65v-2.86l1.01.35c.51.18.82.35.82 1.22Z"/><path fill="#fff" d="M16.19 2H7.81C4.17 2 2 4.17 2 7.81v8.38C2 19.83 4.17 22 7.81 22h8.38c3.64 0 5.81-2.17 5.81-5.81V7.81C22 4.17 19.83 2 16.19 2Zm-1.93 10c.78.27 1.82.84 1.82 2.63 0 1.54-1.2 2.79-2.68 2.79h-.65V18c0 .41-.34.75-.75.75a.76.76 0 0 1-.75-.75v-.58h-.36a3.04 3.04 0 0 1-2.97-3.09.75.75 0 1 1 1.5 0c0 .88.66 1.59 1.47 1.59h.36v-3.39L9.74 12c-.78-.27-1.82-.84-1.82-2.63 0-1.54 1.2-2.79 2.68-2.79h.65V6c0-.41.34-.75.75-.75s.75.34.75.75v.58h.36a3.04 3.04 0 0 1 2.97 3.09.75.75 0 1 1-1.5 0c0-.88-.66-1.59-1.47-1.59h-.36v3.39l1.51.53Z"/>
  </svg>
)

export const EvFlagRU = () => (
